...
int ll_sort(LinkedList* this, int (*pFunc)(void* ,void*), int order)
{
	...
	if(this!=NULL && pFunc!=NULL && (order == 0 || order == 1) && pFunc != NULL)
	{
...
/** \brief Obtiene cada elemento y aplica la funcion que se le pase por parametro, en este caso descuentos
 * \param this LinkedList* Puntero a la lista
 * \param pFunc (*pFunc) Puntero a la funcion criterio
 * \return int Retorna  (-1) Error: si el puntero a la listas es NULL
                                ( 0) Si ok
...
/*
 * \brief filtra por el criterio que se le pase como funcion
 *  \param puntero LinkedList this
 *  \param puntero a funcion pFunc
 *  \return LimkedList puntero a la lista
 */
